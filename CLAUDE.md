...
- Full rule compliance with official Axis & Allies 1942 Second Edition rulebook
- Interactive Terminal User Interface (TUI) for human players
- Strategic NPC AI that can play complete games autonomously
- Support for 6 players (Germany, USSR, UK, Japan, USA, Italy)
...
- ✅ Full Axis & Allies 1942 Second Edition rules
